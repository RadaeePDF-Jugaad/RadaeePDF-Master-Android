...
import com.radaee.ofd.Page.Finder;

/**
 * Inner class.<br/>
 * developer should not use this.
 */
public class OFDFinder {
    ...
    private void find_draw(Canvas canvas, OFDGLPage page, int index, Paint paint, int scrollx, int scrolly) {
    ...
    protected void find_draw(Canvas canvas, OFDGLPage page, int scrollx, int scrolly)//draw current found
    {
        if (!is_cancel) {
            eve_wait();
            is_cancel = true;

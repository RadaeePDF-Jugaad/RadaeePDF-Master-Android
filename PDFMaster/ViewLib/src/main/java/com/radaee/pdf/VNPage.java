...
public class VNPage {
    ...
    {
        return draw(vpage, callback, bmp.get_hand(), vx, vy);
    }
    ...
    public static void DrawStep2(long vpage, BMP bmp, long result) {drawStep2(vpage, bmp.get_hand(), result);}
    public static native void resultDestroy(long result);
    private static native void zoomStart(long vpage, long bmp, int bits);
    public static void ZoomStart(long vpage, BMP bmp, int bits) {zoomStart(vpage, bmp.get_hand(), bits);}

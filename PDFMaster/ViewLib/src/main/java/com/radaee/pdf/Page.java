...
public class Page
{
	public static class Annotation
	{
		 ...
		 * @param idx event type as below:<br/>
		...
		/**
		 * get annotation's 3D data, and save to file. must be *.u3d format.<br/>
		 * this method require professional or premium license
		...
		/**
		 * get annotation's movie data, and save to file.<br/>
		 * this method require professional or premium license
		 * @param save_file full path name to save data.
		 * @return true if save_file created, or false.
		 */
		...
		/**
		 * get annotation's sound data, and save to file.<br/>
		 * this method require professional or premium license
		 * @param paras must be 4 elements array to get parameters. paras[0] == 0, if formated audio file(*.mp3 ...).
		 * @param save_file full path name to save data.
		 * @return true if save_file created, or false.
		 */
		...
		/**
		 * get annotation's attachment data, and save to file.<br/>
		 * this method require professional or premium license
		 * @param save_file full path name to save data.
		 * @return true if save_file created, or false.
		 */
        ...
        /**
		 * set export value and appearance text of edit-box.<br/>
		 * you should render page again to display modified data in viewer.<br/>
		 * this method require premium license.<br/>
		 * @param value value to be set.
		 * @param formatted appearance text string displayed in edit-box.
		 * @return true or false.
		 */
		...
		/**
		 * get export value of combo-box item.<br/>
		 * this method require premium license
		 * @param item 0 based item index. range:[0, GetAnnotComboItemCount()-1]
		 * @return null if this is not combo-box, "" if no item selected, otherwise the item selected.
		 */
		 ...
		 * this method only works under premium license.
         * @param item 0 based item index. range:[0, GetListItemCount())
         * @return
         */
        ...
        /**
         * insert item to list-box.
		 * remove item by index.
		 * this method only works under premium license.
         * @param item 0 based item index. range:[0, GetAnnotComboItemCount())
         * @return true or false
         */
        ...
        /**
         * insert combo item by index.
		 * this method only works under premium license.
         * @param item index of items, range: [0, GetAnnotComboItemCount()]
         * @param val export string.
         * @param txt display string.
         * @return true or false.
         */
		...
		final public Obj GetSignLock()
		{
			long hret = Page.getAnnotSignLock(page.hand, hand);
			if (hret == 0) return null;
			return new Obj(hret);
		}
		final public boolean SetSignLock(Obj obj)
		{
			if (obj == null) return false;
			return Page.setAnnotSignLock(page.hand, hand, obj.get_hand());
		}
		/**
		...
		/**
		 * get annotation submit target on a submit button.<br/>
		 * this method require premium license
		...
		/**
		 * get annotation submit parameters on a submit button.<br/>
		 ...
		 * this method require professional or premium license
		 * @return (ret >> 16) is style of end point, (ret & 0xffff) is style of start point.<br/>
		 * it has following styles:<br/>
		 * 1:OpenArrow<br/>
		 * 2:ClosedArrow<br/>
		 * 3:Square<br/>
		 * 4:Circle<br/>
		 ...
		 * this method require professional or premium license
		 * @param style (style >> 16) is style of end point, (style & 0xffff) is style of start point.<br/>
		 * it has following styles:<br/>
		 * 1:OpenArrow<br/>
		 * 2:ClosedArrow<br/>
		 * 3:Square<br/>
	...
	static private native long newTagBlock(long page, long parent, String tag);
	...
	static private native boolean objsSetImage(long page, int index, Bitmap bmp, boolean has_alpha, boolean interpolate);
	static private native boolean objsSetImageJPEG(long page, int index, String path, boolean interpolate);
	static private native boolean objsSetImageJPX(long page, int index, String path, boolean interpolate);
	static private native boolean objsSetImageJPEGByArray(long page, int index, byte[] data, int len, boolean interpolate);
    static private native boolean objsRemove(long hand, int[] ranges, boolean reload);
	...
	static private native long getAnnotSignLock( long hand, long annot );
	static private native boolean setAnnotSignLock( long hand, long annot, long obj );
	...
	static private native boolean addFieldButton(long page, float[] rect, String name, String label, long app);
	static private native boolean addFieldCheck(long page, float[] rect, String name, String val, long app_on, long app_off);
	static private native boolean addFieldRadio(long page, float[] rect, String name, String val, long app_on, long app_off);
	static private native boolean addFieldEditbox(long page, float[] rect, String name, boolean multi_line, boolean password);
	static private native boolean addFieldCombo(long page, float[] rect, String name, String[] opts);
	static private native boolean addFieldList(long page, float[] rect, String name, String[] opts, boolean multi_sel);
	static private native boolean addFieldSign(long page, float[] rect, String name);
	...
	public int GetPGEditorNodeCount()
	{
		return getPGEditorNodeCount(hand);
	}
	public void SetPGEditorModified(boolean modified)
	{
		setPGEditorModified(hand, modified);
	}
	public EditNode GetPGEditorNode(int idx)
	{
		long handle = getPGEditorNode1(hand, idx);
		if(handle == 0) return null;
		return new EditNode(handle);
	}
	public EditNode GetPGEditorNode(float pdfx, float pdfy)
	{
		long handle = getPGEditorNode2(hand, pdfx, pdfy);
		if(handle == 0) return null;
		return new EditNode(handle);
	}
	...
	{
		return updateWithPGEditor(hand);
	}
	public boolean CancelWithPGEditor()
	{
		return cancelWithPGEditor(hand);
	}
	/**
    ...
    final public boolean RenderToBmp( Bitmap bitmap, Matrix mat )
	{
        ...
        try {
            return renderToBmp(hand, bitmap, mat.get_hand(), Global.g_render_quality);
        }
        catch(Exception e)
        {
            e.printStackTrace();
    ...
    final public boolean RenderToBuf( int[] data, int w, int h, Matrix mat )
	{
        ...
        try {
            return renderToBuf(hand, data, w, h, mat.get_hand(), Global.g_render_quality);
        }catch (Exception e)
        {
            e.printStackTrace();
            return false;
    ...
    final public boolean Render_Normal( DIB dib, Matrix mat )
	{
        if(dib == null || mat == null) return false;
        try {
            return render(hand, dib.get_hand(), mat.get_hand(), 1);
        }catch (Exception e)
        {
            e.printStackTrace();
            return false;
    ...
    final public boolean RenderThumbToDIB(DIB dib)
	{
        ...
        try {
            return renderThumbToDIB(hand, dib.get_hand());
        }
        catch (Exception e)
        {
            e.printStackTrace();
	...
	/**
	 * return unicode from char index
	 * @param index range:[0, ObjsGetCharCount())
	 * @return -1 if char is image, others: text unicode
	 */
	final public int ObjsGetCharUnicode(int index)
	{
		return objsGetCharUnicode(hand, index);
	}

	/**
	 * get image information
	 * @param index range:[0, ObjsGetCharCount()-1]
	 * @return null if char is not image, others: [bits of image, flags, width, height, xx, yx, xy, yy, x0, y0]<br/>
	 * bits of image: bits of image.<br/>
	 * flags: flags&1: mask, flags&2: has palette, flags&4: need interpolate, flags&8: is this image inline data? flags&48:color space, flags higher bits: blend mode.<br/>
	 * width is image width.<br/>
	 * height is image height.<br/>
	 */
	final public int[] ObjsGetImageInfo(int index)
	{
		return objsGetImageInfo(hand, index);
	}
	/**
	 * get image pixels and palettes
	 * @param index range:[0, ObjsGetCharCount()-1]
	 * @return null if char is not image, others: pixels data and information, array like [(bits<<16)|number_pals, stride, width, height, palette, pixels...]<br/>
	 ...
	 */
	final public int[] ObjsGetImageData(int index)
	{
		return objsGetImageData(hand, index);
	}

	/**
	 * set image data.
	 * @param index char index, range:[0, ObjsGetCharCount()-1]
	 * @param bmp 32 bits Bitmap object, must format as ARGB_8888
	 * @param has_alpha true if the bitmap has alpha data, else ignore all alpha channel data and replace as 255.
	 * @param interpolate interpolate pixels when rendering image scale large than origin image size.
	 * @return
	 */
	public boolean ObjsSetImage(int index, Bitmap bmp, boolean has_alpha, boolean interpolate)
	{
		return objsSetImage(hand, index, bmp, has_alpha, interpolate);
	}
	/**
	 ...
	 */
	public boolean ObjsSetImageJPEG(int index, String path, boolean interpolate)
	{
		return objsSetImageJPEG(hand, index, path, interpolate);
	}
	/**
	 ...
	 * @return true or false, mask image always return false.
	 */
	public boolean ObjsSetImageJPEGByMem(int index, byte[] data, int len, boolean interpolate)
	{
		return objsSetImageJPEGByArray(hand, index, data, len, interpolate);
	}
	/**
	 ...
	 * @return true or false, mask image always return false.
	 */
	public boolean ObjsSetImageJPX( int index, String path, boolean interpolate )
	{
		return objsSetImageJPX(hand, index, path, interpolate);
	}
	/**
     * remove chars from PDF page.
     * @param range array of char index pair.<br/>
     * example: a string "hello_world." pass [0, 2, 6, 8] the result will be "__llo___rld.", where '_' mean the blank char.
     * @param flush is flush cache data after this invoking? flush not effect saved data, only effect page operator cache.<br/>
     * if you close this page after this call, pass false to flush shall has better performance.
     * @return true or false.
     */
    final public boolean ObjsRemove(int[] range, boolean flush)
    {
        return objsRemove(hand, range, flush);
    }
	/**
    ...
    final public boolean AddAnnotInk( Matrix mat, Ink ink, float orgx, float orgy )
	{
		...
		return addAnnotInk( hand, mat.get_hand(), ink.hand, orgx, orgy );
	}
	/**
	 * add hand-writing to page.<br/>
	 * you should re-render page to display modified data.<br/>
    ...
    final public boolean AddAnnotHWriting( Matrix mat, HWriting hwriting, float orgx, float orgy )
	{
		...
		return addAnnotHWriting(hand, mat.get_hand(), hwriting.hand, orgx, orgy);
	}
	/**
    ...
    final public boolean AddAnnotGlyph( Matrix mat, Path path, int color, boolean winding )
	{
		...
		return addAnnotGlyph(hand, mat.get_hand(), path.m_hand, color, winding);
	}
	/**
    ...
    final public boolean AddAnnotRect( Matrix mat, float[] rect, float width, int color, int fill_color )
	{
		...
		return addAnnotRect(hand, mat.get_hand(), rect, width, color, fill_color);
	}
	/**
	 * add line to page.<br/>
	 * you should re-render page to display modified data.<br/>
    ...
    final public boolean AddAnnotLine( Matrix mat, float[] pt1, float[] pt2, int style1, int style2, float width, int color, int fill_color )
	{
		...
		return addAnnotLine(hand, mat.get_hand(), pt1, pt2, style1, style2, width, color, fill_color);
	}
	/**
	...
	{
        if(mat == null) return false;
		return addAnnotEllipse(hand, mat.get_hand(), rect, width, color, fill_color);
	}
	...
	public boolean AddAnnotMarkup( Matrix mat, float[] rects, int type )
	{
		...
		return addAnnotMarkup( hand, mat.get_hand(), rects, color, type );
	}
	/**
	 * add hand-writing to page.<br/>
	 * you should re-render page to display modified data.<br/>
	 ...
	 * @param text_clr text color, formated as 0xAARRGGBB. AA must same to AA of line_clr
	 * @return true or false.<br/>
	 * the added annotation can be obtained by Page.GetAnnot(Page.GetAnnotCount() - 1), if this method return true.
	 */
	 ...
	 * the added annotation can be obtained by Page.GetAnnot(Page.GetAnnotCount() - 1), if this method return true.
	 */
    final public boolean AddAnnotBitmap(Document.DocImage image, float[] rect )
	{
	...
	{
		return addAnnotEditbox( hand, mat.get_hand(), rect, line_clr, line_w, fill_clr, tsize, text_clr );
	}
	/**
	 * Start Reflow.<br/>
	 * this method require professional or premium license
	...
	{
        if(dib == null) return false;
		return reflow( hand, dib.get_hand(), orgx, orgy );
	}
	/**
	 ...
	 * @return
	 */
	public boolean AddFieldButton(float[] rect, String name, String label, DocForm app)
	{
		if(app == null)
			return addFieldButton(hand, rect, name, label, 0);
		else
			return addFieldButton(hand, rect, name, label, app.hand);
	}
	 ...
	 * @return
	 */
	public boolean AddFieldCheck(float[] rect, String name, String val, DocForm app_on, DocForm app_off)
	{
		if(app_on == null || app_off == null)
			return addFieldCheck(hand, rect, name, val, 0, 0);
		else
			return addFieldCheck(hand, rect, name, val, app_on.hand, app_off.hand);
	}
	 ...
	 * @return
	 */
	public boolean AddFieldRadio(float[] rect, String name, String val, DocForm app_on, DocForm app_off)
	{
		if(app_on == null || app_off == null)
			return addFieldRadio(hand, rect, name, val, 0, 0);
		else
			return addFieldRadio(hand, rect, name, val, app_on.hand, app_off.hand);
	}
	 ...
	 * @return true or false.
	 */
	public boolean AddFieldEditbox(float[] rect, String name, boolean multi_line, boolean password)
	{
		return addFieldEditbox(hand, rect, name, multi_line, password);
	}
	 ...
	 * @return
	 */
	public boolean AddFieldCombo(float[] rect, String name, String[] opts)
	{
		return addFieldCombo(hand, rect, name, opts);
	}
	 ...
	 * @return
	 */
	public boolean AddFieldList(float[] rect, String name, String[] opts, boolean multi_sel)
	{
		return addFieldList(hand, rect, name, opts, multi_sel);
	}

	/**
	 * add a empty signature field.
	 * @param rect [left, top, right, bottom] in PDF coordinate system.
	 * @param name part field name, example "fld1"
	 * @return
	 */
	public boolean AddFieldSign(float[] rect, String name)
	{
		return addFieldSign(hand, rect, name);
	}
	/**
	 ...
	 * @return ResImage object or null.
	 */
	 ...
	 * @return ResGState object or null.
	 */
     ...
     * @return ResForm object, or null if failed.
     */
	 ...
	 * if you need to render page after this method please pass true.<br/>
	 * if pass false, added texts won't be displayed, content will be written in PDF file when Document.Save() or Document.SaveAs() or Document.EncryptAs() invoked.
	 * @return true or false.
	 */
	 ...
	 */
    public TagBlock NewTagBlock(Document.TagGroup parent, String tag)
	{
		if(parent == null) return null;
		long hval = newTagBlock(hand, parent.m_hand, tag);
		if(hval == 0) return null;
		return new TagBlock(hval);
	}
}

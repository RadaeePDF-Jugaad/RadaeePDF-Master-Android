...
public class OFDGLLayoutCurl extends OFDGLLayout {
    ...
    public OFDGLLayoutCurl(Context context) {
        super(context);
        m_type = 0;
        m_goto_page = -1;
        m_text_shadow = 0;
    ...
    public void gl_draw(GL10 gl10) {
        ...
        if (m_type > 0 && m_cur_page < m_page_cnt - 1) {
            ...
            m_pages[m_cur_page].gl_draw_curl(gl10, m_thread, m_def_text, m_text_shadow, 0, m_touch_x, m_touch_y);
    }
    ...
    public OFDPos vGetPos(int vx, int vy) {
        ...
        pos.pageno = pgno;
        pos.x = gpage.GetOFDX(vx);
        pos.y = gpage.GetOFDY(vy);
        return pos;
    }

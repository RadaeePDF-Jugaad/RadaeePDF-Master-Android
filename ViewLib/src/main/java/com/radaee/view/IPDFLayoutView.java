...
public interface IPDFLayoutView {
    interface PDFLayoutListener {
         ...
         */
        void OnPDFBlankTapped(int pageno);
         ...
         */
        void OnPDFTextSelected(String text, float x, float y);

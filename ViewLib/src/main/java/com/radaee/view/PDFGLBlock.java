...
public class PDFGLBlock {
    ...
    protected PDFGLBlock(PDFGLBlock src, Document doc) {
        m_doc = doc;
    ...
    protected PDFGLBlock(Document doc, int pageno, float scale, int x, int y, int w, int h, int ph) {
        m_doc = doc;
        m_pageno = pageno;
        m_scale = scale;
        m_x = x;

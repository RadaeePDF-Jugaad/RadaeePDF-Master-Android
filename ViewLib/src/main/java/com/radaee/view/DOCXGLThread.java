...
public class DOCXGLThread extends Thread {
    ...
    public void run() {
        ...
        m_hand = new Handler(Looper.myLooper()) {
            public void handleMessage(Message msg) {
                ...
                {
                    DOCXGLBlock blk = (DOCXGLBlock) msg.obj;
                    blk.bk_render();
                    if (m_hand_gl != null)
                    ...
                    int ret = ((DOCXFinder) msg.obj).find();
                    if (m_hand_gl != null)
    ...
    public void render_start(DOCXGLBlock blk) {
        if (blk != null && blk.gl_start()) {
            m_hand.sendMessage(m_hand.obtainMessage(0, blk));
        }
    }

    public boolean render_end(GL10 gl10, DOCXGLBlock blk) {
    ...
    protected void find_start(DOCXFinder finder) {

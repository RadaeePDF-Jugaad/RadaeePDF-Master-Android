...
public class PDFEditFinder {
    ...
    private void find_draw(Canvas canvas, PDFPage page, int index, Paint paint, int scrollx, int scrolly) {
    ...
    protected void find_draw(Canvas canvas, PDFPage page, int scrollx, int scrolly)//draw current found
    {
        if (!is_cancel) {
            eve_wait();
            is_cancel = true;
    ...
    private void find_draw(Canvas canvas, PDFEditPage page, int index, Paint paint, int scrollx, int scrolly) {
        int ichar = m_finder.GetFirstChar(index);
    ...
    protected void find_draw(Canvas canvas, PDFEditPage page, int scrollx, int scrolly)//draw current found
    {
        if (!is_cancel) {
            eve_wait();
            is_cancel = true;
